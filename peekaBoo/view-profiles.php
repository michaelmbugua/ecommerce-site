    ...
    <div class="mb15">
            ...
            <div class="col-md-12">
                <form method="post" action="view-profiles.php">
                    ...
                    <div class="col-md-10 col-sm-12">
                         <input type="submit" name="Search" value="Search" class="btn btn-dark w-100" style="background-color: black; color: white;">
                    </div>
                    <div class="col-md-2 col-sm-12">
                        <input type="submit" name="Reset" value="Reset filters" class="btn btn-info w-100" style="background-color: black; color: white;">
                    </div>
                    </div>
                </form>
            </div>
        ...
        if (!empty($userObj)) {
            if ($userObj["user_role"] === "regular") {
                ...
                <div class="row mb-10">
                <div class="col-md-12">
    <a href="./become-premium-member.php" class="btn btn-warning w-100 btnPremium" name="BecomePremium"
       style="background-color: black; color: white;">Become a premium member</a>
</div>
        ...
        data-target="#loginModal" style="background-color: #FFB6C1;color: black;">
    Send Message
</button>
        ...
        data-target="#loginModal" style="background-color: #8ABAD3FF;color: black;">
    Send Wink
</button>
        ...
        data-target="#loginModal" style="background-color: bisque;color: black;">
    Favourite
</button>
